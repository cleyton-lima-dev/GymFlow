...
class ConfigureWorkoutTemplateExercisePage
    extends StatefulWidget {
  const ConfigureWorkoutTemplateExercisePage({
  ...
  final WorkoutTemplateDraftExercise? initialExercise;

  @override
  State<ConfigureWorkoutTemplateExercisePage> createState() =>
      _ConfigureWorkoutTemplateExercisePageState();
}

class _ConfigureWorkoutTemplateExercisePageState
    extends State<ConfigureWorkoutTemplateExercisePage> {
  ...
  void initState() {
    ...
    _setsController = TextEditingController(
      text: initial == null ? '' : '${initial.sets}',
    );
