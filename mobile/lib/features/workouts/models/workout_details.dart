class WorkoutDetails {
  ...
  factory WorkoutDetails.fromJson(
    ...
    return WorkoutDetails(
      ...
      json['sourceWorkoutTemplateId'] as String?,
...
class WorkoutDayDetails {
  ...
  factory WorkoutDayDetails.fromJson(
      Map<String, dynamic> json,
      ) {
    ...
    return WorkoutDayDetails(
      ...
      exercises: rawExercises
          .map(
            (exercise) =>
            WorkoutExerciseDetails.fromJson(
              Map<String, dynamic>.from(
                exercise as Map,
              ),
            ),
...
class WorkoutExerciseDetails {
  ...
  factory WorkoutExerciseDetails.fromJson(
      Map<String, dynamic> json,
      ) {
