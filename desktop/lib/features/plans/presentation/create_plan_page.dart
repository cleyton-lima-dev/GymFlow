...
import 'package:avelri_gestao/features/plans/presentation/create_plan_view_model.dart';
...
class CreatePlanPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) =>
          CreatePlanViewModel(PlansService(context.read<ApiClient>())),
...
class _CreatePlanViewState extends State<_CreatePlanView> {
  ...
  Future<void> _submit() async {
    ...
    final created =
    await context.read<CreatePlanViewModel>().createPlan(
