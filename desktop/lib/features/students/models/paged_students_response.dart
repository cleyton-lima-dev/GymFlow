...
class PagedStudentsResponse {
  ...
  factory PagedStudentsResponse.fromJson(Map<String, dynamic> json) {
    ...
    final items = rawItems
        .map((item) {
          if (item is! Map) {
            throw const FormatException('Invalid student item.');
          }

          return StudentSummary.fromJson(Map<String, dynamic>.from(item));
        })
